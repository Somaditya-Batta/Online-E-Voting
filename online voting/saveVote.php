    	...
    	<div class="row">
          ...
          require('config.php');
					...
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["voterID"]) && isset($_POST["selectedCandidate"]))
					{
						...
						$voterAdhar= test_input($_POST["AadharNumber"]);
						$selection= test_input($_POST["selectedCandidate"]);
						$_SESSION['vname']=$_POST["voterName"];
...
$ss="select * from acc_info where aadhar='$voterAdhar' and first_name='$name'";
$res=mysqli_query($conn,$ss);
 $ret=mysqli_fetch_array($res);
 if($ret>0)
{

				$sql= "INSERT INTO db_evoting.tbl_users() VALUES(null,'".$name."','".$email."','".$voterID."','".$selection."',null);";
...
{
	echo "<h3 class='text-info specialHead text-center'><strong> SORRY! YOU HAVE PROVIDED WRONG CREDENTIALS..</strong></h3>";
	
}	
				?>
        <br>

<a href="feedback.php">"SUBMIT YOUR VALUABLE FEEDBACK"></a>
