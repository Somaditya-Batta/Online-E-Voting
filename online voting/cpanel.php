    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg">E-VOTING SYTEM</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          <ul class="nav navbar-nav">
			...
			<li><a href="manageaccounts.php"><span class="subFont"><strong>Account Activation</strong></span></a></li>
            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>YSR telangana party</strong><br>";
                  echo "
                  <div class='progress'>
